...
import styles from './SocketCustomization.module.css'

const SocketCustomizationModal = ({ isOpen, onClose, customizations, itemName, quantity, price }) => {
...
export default SocketCustomizationModal